...
\begin{document}
    ...
    Étudiant en deuxième année d'école d'ingénieur à Télécom Paris, je suis
    actuellement à la recherche d'opportunités de stage dans le cadre d'une
    césure académique pour l'année 2026-2027. Enthousiaste en informatique, je
    porte grand intérêt aux systèmes embarqués et à la science des données,
    domaines dans lesquels je développe actuellement mes compétences.
